...
@Entity
@Table(name = "ai_ns_table_audit")
public class AiNsAudit {
	...
	public AiNsAudit(int sl_No, String animal_Tag_Number, int user_Gewog_Id, String technique_Name, String semen_Type,
			...
			float longitude, String pD_Status, String breeding_Status, Date pD_Status_Date, String type_Of_Event,
			Date date_Of_Pd_Status, String type_Of_Assited_Formula, String remarks) {
		super();
		Sl_No = sl_No;
